...
export function AppSidebar({ isCollapsed }: { isCollapsed: boolean }) {
  ...
  return (
    <div className={cn(
      "h-screen bg-gradient-to-b from-white to-purple-50 dark:from-black dark:to-black border-r border-purple-200 dark:border-zinc-800 flex-shrink-0 z-40 transition-all duration-300 overflow-hidden",
      isCollapsed ? "w-0 lg:w-[70px]" : "w-[250px]"
    )}>
      <div className="flex flex-col h-full">
        {/* Header */}
        <div className="p-4 bg-gradient-to-r from-purple-100/80 to-purple-200/50 dark:from-purple-900/20 dark:to-purple-800/10">
          <motion.div 
        ...
        {/* Footer */}
        <div className="mt-auto bg-purple-50 dark:bg-black border-t border-purple-200 dark:border-zinc-800">
