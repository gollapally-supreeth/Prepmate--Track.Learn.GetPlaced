    ...
    <div className="flex flex-col items-center mt-2 w-full">
      {edit.basic ? (
        <div className="flex flex-col gap-2 w-full items-center">
          <Input value={basicInfo.fullName} onChange={e => setBasicInfo({ ...basicInfo, fullName: e.target.value })} className="text-lg font-bold text-center" placeholder="Full Name (e.g. John Doe)" />
          <Input value={basicInfo.username} onChange={e => setBasicInfo({ ...basicInfo, username: e.target.value })} className="text-base text-center" placeholder="Username (e.g. johndoe123)" />
          <Input value={basicInfo.contact} onChange={e => setBasicInfo({ ...basicInfo, contact: e.target.value })} className="text-xs text-center" placeholder="Contact Number (e.g. 9876543210)" />
      ...
      <div className="flex gap-2 mt-2">
        ...
        {edit.status ? (
          <>
            <Input value={basicInfo.status} onChange={e => setBasicInfo({ ...basicInfo, status: e.target.value })} className="text-xs" placeholder="Status (e.g. Open to work, Student, etc.)" />
